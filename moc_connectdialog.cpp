...
static const char qt_meta_stringdata_ConnectDialog[] = {
    "ConnectDialog\0\0maybeSave()\0index\0"
    "savedCredentialSelected(int)\0success\0"
    "walletOpened(bool)\0"
};
...
void ConnectDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->maybeSave(); break;
        case 1: _t->savedCredentialSelected((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: _t->walletOpened((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
    }
}
